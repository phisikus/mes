...
public class PurchaseHooksTest {
  ...
  public final void onCreateCheckDuplicateTest() {
    ...
    List<SearchCriterion> searchCriterionList = restrictionCaptor.getAllValues();

    assertEquals(searchCriterionList.size(), 2);
    assertNotNull(searchCriterionList.get(0));
    assertNotNull(searchCriterionList.get(1));
  }
